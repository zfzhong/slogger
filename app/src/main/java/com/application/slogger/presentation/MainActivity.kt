...
//class MainActivity: AppCompatActivity(), SloggerMainInterface {
    ...
    fun checkBLEPermissions() {
        ...
        if (shouldShowRequestPermissionRationale(Manifest.permission.ACCESS_BACKGROUND_LOCATION)) {
            // Show a dialog explaining why background location access is needed
            AlertDialog.Builder(this)
                .setTitle("Background Location Access Needed")
                .setMessage("This app needs background location access to provide continuous tracking features.")
                .setPositiveButton("OK") { dialog, _ ->
                    // Request background location access after user accepts the explanation
