...
import com.application.sloggerlib.getDay
import com.application.sloggerlib.getHour
import com.application.sloggerlib.getMinute
import com.application.sloggerlib.getMonth
import com.application.sloggerlib.getSecond
...
//                }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val bleMode = configParams.bleMode
        val bleItem = ConfigItem("BLEMode", "BLE", bleMode.toString())
        configList.add(bleItem)
        ...
        configAdapter.onItemClick = {
            if (it.tag == "DeviceName") {
                ...
                sensorFreqResultLauncher.launch(intent)
            }else if (it.tag == "BLEMode") {
                val intent = Intent(this, SensorFreqActivity::class.java)
                intent.putExtra("Tag", it.tag)
                intent.putExtra("Mode", configParams.bleMode.toString())
                sensorFreqResultLauncher.launch(intent)
